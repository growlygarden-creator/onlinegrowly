...
const translations = {
  no: {
    ...
    "settings.soilPairingActive": "Paring aktiv til",
    "settings.soilSensor": "Jordsensor",
    "settings.soilSensorPlant": "Plante for jordsensor",
    "settings.soilBatteryLevel": "Batteri",
    "settings.soilBatteryRemaining": "Estimat igjen",
    "settings.soilSensorSchedule": "Plan for jordsensor",
    "settings.soilDayStart": "Dag starter",
    "settings.soilNightStart": "Natt starter",
    "settings.soilSunScheduleTitle": "Automatisk med sola",
    "settings.soilSunScheduleBody": "Dag starter ved soloppgang for dyrkestedet. Når sola går ned, bruker jordsensorene nattintervallet.",
    "settings.soilSunScheduleMissingLocation": "Sett dyrkested under vær, så styrer Growly dag og natt etter soloppgang og solnedgang.",
    ...
    "settings.pairSoilSensor": "Par jordsensor",
    "settings.pairingSoilSensor": "Starter paring...",
  ...
  en: {
    ...
    "settings.soilBatteryLevel": "Battery",
    "settings.soilBatteryRemaining": "Estimated left",
    "settings.soilSensorSchedule": "Soil sensor schedule",
    "settings.soilDayStart": "Day starts",
    "settings.soilNightStart": "Night starts",
    "settings.soilSunScheduleTitle": "Automatic with the sun",
    "settings.soilSunScheduleBody": "Day starts at sunrise for the growing location. When the sun sets, soil sensors use the night interval.",
    "settings.soilSunScheduleMissingLocation": "Set a growing location under weather, then Growly uses sunrise and sunset for day and night.",
