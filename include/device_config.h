...
constexpr char FIRMWARE_VERSION[] = "0.1.16-memory-backpressure";
...
constexpr unsigned long DEVICE_CONFIG_POLL_INTERVAL_MS = 300000;
constexpr unsigned long DEVICE_STATUS_HEARTBEAT_INTERVAL_MS = 300000;
